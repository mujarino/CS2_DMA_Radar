...
def world_to_minimap(x, y, pos_x, pos_y, scale, map_image, screen, zoom_scale, rotation_angle):
    try:
        ...
        center_x, center_y = screen_height // 2, screen_height // 2
                ...
                if Hp != 0:
                    ...
                    if isdefusing == 1:
                        ...
                        if hasdefuser:
                            ...
                            pygame.draw.line(screen, (0, 255, 0), (transformed_x + cross_size, transformed_y - cross_size), (transformed_x - cross_size, transformed_y + cross_size), 2)1
                screen.blit(text_surface, (transformed_x, transformed_y))
        except:
            pass
